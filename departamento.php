...
<html lang="es">
	...
	<body>
		...
		<section>
		<form method="post" class="form" action="reportedep.php?depa=<?php echo $depa?>">
		<button class="btn btn-warning">Generar reporte</button>
		</form>
			<table class="table"><br><br><br><br>
				<div class="alert alert-info"><h1 style="text-align: center;">
					<?php
					echo $recorridonom['nombre'];
					 ?></h1></div>
				<tr class="bg-primary">
					<th>Categoria</th>
					<th>#</th>
